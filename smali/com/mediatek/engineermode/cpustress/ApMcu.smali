...
.method static synthetic access$000(Lcom/mediatek/engineermode/cpustress/ApMcu;)V
    .locals 0
    .param p0, "x0"    # Lcom/mediatek/engineermode/cpustress/ApMcu;
...
.method private updateTestCount(IIIIIIIIIIII)V
    .locals 9
    .param p1, "neonTest"    # I
    .param p2, "neonTestPass"    # I
    .param p3, "maxPowerTest"    # I
    .param p4, "maxPowerTestPass"    # I
    .param p5, "dhryTest"    # I
    .param p6, "dhryTestPass"    # I
    .param p7, "memcpyTest"    # I
    .param p8, "memcpyTestPass"    # I
    .param p9, "fdctTest"    # I
    .param p10, "fdctTestPass"    # I
    .param p11, "imdctTest"    # I
    .param p12, "imdctTestPass"    # I
    ...
    invoke-virtual {p0, v2}, Lcom/mediatek/engineermode/cpustress/ApMcu;->getString(I)Ljava/lang/String;
...
.method private updateTestResult()V
    ...
    invoke-virtual/range {v28 .. v28}, Ljava/lang/NullPointerException;->getMessage()Ljava/lang/String;
...
.method private updateTestUi(ZJIJIIIIII)V
    ...
    invoke-virtual {p0, v2}, Lcom/mediatek/engineermode/cpustress/ApMcu;->removeDialog(I)V
...
.method public onCheckedChanged(Landroid/widget/CompoundButton;Z)V
    ...
    .line 428
    iget-object v3, p0, Lcom/mediatek/engineermode/cpustress/ApMcu;->mBoundService:Lcom/mediatek/engineermode/cpustress/CpuStressTestService;
...
.method public onClick(Landroid/view/View;)V
    ...
    .line 372
    invoke-virtual {p0}, Lcom/mediatek/engineermode/cpustress/ApMcu;->getResources()Landroid/content/res/Resources;
    ...
    .line 393
    iget-object v6, p0, Lcom/mediatek/engineermode/cpustress/ApMcu;->mBoundService:Lcom/mediatek/engineermode/cpustress/CpuStressTestService;
    ...
    invoke-virtual {p0, v6}, Lcom/mediatek/engineermode/cpustress/ApMcu;->showDialog(I)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 86
    invoke-super {p0, p1}, Lcom/mediatek/engineermode/cpustress/CpuStressCommon;->onCreate(Landroid/os/Bundle;)V

    .line 87
    const v5, 0x7f030040

    invoke-virtual {p0, v5}, Lcom/mediatek/engineermode/cpustress/ApMcu;->setContentView(I)V

    .line 88
    const v5, 0x7f0b01be

    invoke-virtual {p0, v5}, Lcom/mediatek/engineermode/cpustress/ApMcu;->findViewById(I)Landroid/view/View;
    ...
    invoke-virtual {p0}, Lcom/mediatek/engineermode/cpustress/ApMcu;->getPackageName()Ljava/lang/String;
    ...
    .line 113
    .local v3, "id":I
    invoke-virtual {p0, v3}, Lcom/mediatek/engineermode/cpustress/ApMcu;->findViewById(I)Landroid/view/View;
    ...
    invoke-virtual {p0, v6}, Lcom/mediatek/engineermode/cpustress/ApMcu;->getString(I)Ljava/lang/String;
    ...
    iput-object v5, p0, Lcom/mediatek/engineermode/cpustress/ApMcu;->mHandler:Landroid/os/Handler;
